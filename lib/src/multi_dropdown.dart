...
class MultiDropdown<T extends Object> extends StatefulWidget {
  ...
  ///
  /// The [selectedItemMaxLines] is the maximum number of lines for the selected item text.
  /// This is used when [singleSelect] is true, to limit the number of lines for the selected item text displayed in the field.
  /// If null (default), the text will be displayed without any limit on the number of lines.
  ///
  ...
  /// The maximum number of lines for the selected item text.
  ///
  /// This is used when [singleSelect] is true, to limit the number of lines
  /// for the selected item text displayed in the field.
  ///
  ...
  Widget _buildField() {
    ...
    if (widget.singleSelect) {
      return Text(selectedOptions.first.label,
          ...
          overflow: widget.selectedItemMaxLines != null ? TextOverflow.ellipsis : null);
    }
      ...
      child: Row(
        ...
        children: [
          Text(option.label,
              ...
              maxLines: chipDecoration.maxLines,
              overflow: chipDecoration.maxLines != null ? TextOverflow.ellipsis : null),
